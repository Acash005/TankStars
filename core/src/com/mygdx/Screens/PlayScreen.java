...
public class PlayScreen implements Screen {
    ...
    private final Tank1 tank1;
    private final Tank2 tank2;
    ...
    public PlayScreen(MyGdxGame game){
        ...
        tank1 = Tank1.getInstance(world, this, "Tank1", 1, 1, 80, 80);
        tank2 = Tank2.getInstance(world, this, "Tank2", 51, 1, 350, 80);
    ...
    public void bulletCollisions(float dt){
        ...
        if(bullet1.b2body.getPosition().x > 2 && bullet1.b2body.getPosition().y < 0.55 && flag.equals("P1")) {
        ...
        if(bullet2.b2body.getPosition().x < 2 && bullet2.b2body.getPosition().y < 0.55 && flag.equals("P2")){
    ...
    public void handleInput(){
        ...
        if (Gdx.input.isKeyPressed(Input.Keys.UP) && flag.equals("P1")){
        ...
        if (Gdx.input.isKeyPressed(Input.Keys.DOWN) && flag.equals("P1")) {
            tank1.b2body.setTransform(tank1.b2body.getPosition(), (float) ((tank1.b2body.getAngle())-0.017));
            hud.pAngle1((float)(((tank1.b2body.getAngle()) * 57.295))%360);
        }

        if (Gdx.input.isKeyPressed(Input.Keys.Z) && flag.equals("P1")) {
            power1 += 2;
            if(power1 >= 500) power1 = 200;
            hud.pPower1(power1);

        }
        if (Gdx.input.isKeyPressed(Input.Keys.X) && flag.equals("P1")) {
            power1 -= 2;
            if(power1 <= 200) power1 = 500;
            hud.pPower1(power1);
        }

        if (Gdx.input.isKeyJustPressed(Input.Keys.ENTER) && flag.equals("P1")) {
        ...
        if (Gdx.input.isKeyPressed(Input.Keys.D) && tank2.b2body.getLinearVelocity().x <= 0.37 && flag.equals("P2")){
            fuel2 -= 2;
        ...
        if (Gdx.input.isKeyPressed(Input.Keys.W) && flag.equals("P2")){
        ...
        if (Gdx.input.isKeyPressed(Input.Keys.S) && flag.equals("P2")) {
            tank2.b2body.setTransform(tank2.b2body.getPosition(), (float) ((tank2.b2body.getAngle())-0.017));
            hud.pAngle2((float)((((tank2.b2body.getAngle()) * 57.295))+360)%360);
        }

        if (Gdx.input.isKeyPressed(Input.Keys.Z) && flag.equals("P2")) {
            power2 += 2;
            if(power2 >= 500) power2 = 200;
            hud.pPower2(power2);

        }
        if (Gdx.input.isKeyPressed(Input.Keys.X) && flag.equals("P2")) {
            power2 -= 2;
        ...
        if (Gdx.input.isKeyJustPressed(Input.Keys.ENTER) && flag.equals("P2")) {
